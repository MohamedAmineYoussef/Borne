...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/BorneFontainetesteur.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   -lgtest_main -lgtest -lpthread 

${TESTDIR}/TestFiles/f2: ${TESTDIR}/tests/BorneStationnementtesteur.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.cc} -o ${TESTDIR}/TestFiles/f2 $^ ${LDLIBSOPTIONS}   -lgtest_main -lgtest -lpthread 

${TESTDIR}/TestFiles/f3: ${TESTDIR}/tests/BorneTesteur.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
...
${TESTDIR}/tests/BorneFontainetesteur.o: tests/BorneFontainetesteur.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BorneFontainetesteur.o tests/BorneFontainetesteur.cpp


${TESTDIR}/tests/BorneStationnementtesteur.o: tests/BorneStationnementtesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BorneStationnementtesteur.o tests/BorneStationnementtesteur.cpp


${TESTDIR}/tests/BorneTesteur.o: tests/BorneTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BorneTesteur.o tests/BorneTesteur.cpp


${TESTDIR}/tests/RegistreBorneTesteur.o: tests/RegistreBorneTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/RegistreBorneTesteur.o tests/RegistreBorneTesteur.cpp
